...
ENV PORT=8080 GATEWAY_PORT=8080 XRAY_LOGLEVEL=info DATA_DIR=/data XRAY_CONFIG=/etc/xray/config.json REALITY_FINGERPRINT=chrome XHTTP_PATH=/xhttp XHTTP_MODE=auto ENABLE_VLESS_ENCRYPTION=true REALITY_SNI_CANDIDATES_FILE=/opt/xray/config/reality-sni-candidates.txt SUBSCRIPTION_FILE=/data/subscription.txt SUBSCRIPTION_TOKEN_FILE=/data/subscription_token.txt
EXPOSE 8080
